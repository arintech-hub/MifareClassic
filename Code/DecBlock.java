...
public class DecBlock {
    ...
    public void decValue(byte[] val, int block, int sector){
        ...
        try{
            ...
            byte[] c_valueAdd = { (byte) 0xFF, (byte) 0xF0, (byte) 0x00, (byte) 0x05, (byte) 0x06,  
                                  (byte) 0xC0, (byte) 0x05, val[3], val[2], val[1],
                                  val[0]};
            ...
            System.out.println(data);
	        if(data.equals("6982")){
	      	    System.out.println("Addr #0"+b+": AUTEN ERROR");
            }
            else{
		        data = data.substring(0, 32);
	            System.out.println("Addr #"+b+": "+formatedData(data));
    ...
    public static void main(String[] args) {
        ...
        test.decValue(Inc,block,sector);
